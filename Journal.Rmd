...
## different variables will have different colors based off of the class of vehicle. Color could also just be "blue" and then all the points would be that color
```
...
## size of the scatter point changes based off of the class of car
```
...
## alpha controls the transparency of the points while shape controls the shape of them
```
